...
sealed class NavScreen(var route: String) {
    ...
    object Home : NavScreen("home") {
        sealed class BottomNavItem(var route: String, var icon: ImageVector, var title: String) {
            object BreakingNews : BottomNavItem("articles", Icons.Default.Announcement, "News")
    ...
    object ArticleDetail : NavScreen("articleDetails") {
        const val routeWithArgument: String = "articleDetails/{articleId}"
        const val argument0: String = "articleId"
    }
}
